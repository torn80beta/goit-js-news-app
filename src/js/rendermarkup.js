...
function onCardClick(e) {
  ...
  if (e.target.tagName.toLowerCase() !== 'button') {
    ...
    // console.log(favoriteStorage.selectedNews);
    ...
    // favoriteStorage.addNews(data);
    // favoriteBtn.classList.replace('favorite-button__activ', 'add-to-favorite');
    // if (favoriteStorage.hasNews(data)) {
    //   favoriteStorage.removeNews(data);
    ...
    // favoriteBtn.classList.toggle('favorite-button__activ');
    // if (favoriteBtn.classList.contains('favorite-button__activ')) {
    //   favoriteStorage.addNews(data);
    // } else {
    // }
